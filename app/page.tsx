...
const MOCK_DATA = {
  ...
  users: {
    'john.doe': {
      ...
      alternateEmail: 'john.doe.work@company.com',
    ...
    'jane.smith': {
      ...
      alternateEmail: 'jane.smith.work@company.com',
  ...
  transactions: [
    { date: '2026-01-28', description: "Cashier's Check", amount: 29966, type: 'credit' },
    { date: '2026-02-12', description: "Cashier's Check", amount: 42160, type: 'credit' },
  ],
  navbar: [
            ...
            <div className="border border-gray-200 bg-white p-8">
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                {loadingBalance ? (
                  ...
                  <p className="text-4xl font-bold text-gray-900">${accountData?.balance.toFixed(2)}</p>
                )}
              </div>
              <button
            ...
            {userProfile && (
              <div className="space-y-8">
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <p className="text-lg text-gray-900">{userProfile.preferredName}</p>
                </div>
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <p className="text-lg text-gray-900">{userProfile.businessPhone}</p>
                </div>
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <p className="text-lg text-gray-900">{accountData?.number.slice(-4).padStart(16, '*')}</p>
                </div>
